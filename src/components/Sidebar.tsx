...
import { Building, CalendarDays, ShoppingBag, Calculator, Palette, MessageSquare, Plus, Trash2, Sliders, Menu, ChevronLeft } from 'lucide-react';
    ...
    <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <div className="sidebar-content" style={{ display: isCollapsed ? 'none' : 'block' }}>
        ...
        <Accordion 
          ...
          headerAction={<Toggle name="showStoreInfo" checked={data.showStoreInfo} onChange={handleChange} />}
        >
          <div className="form-group">
            <label className="form-label">Store Name</label>
            <input className="form-input" name="storeName" value={data.storeName} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label className="form-label">Address</label>
            <textarea className="form-textarea" name="storeAddress" value={data.storeAddress} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label className="form-label">Phone</label>
            <input className="form-input" name="storePhone" value={data.storePhone} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label className="form-label">Website</label>
            <input className="form-input" name="storeWebsite" value={data.storeWebsite} onChange={handleChange} />
          </div>
        </Accordion>
        ...
        <Accordion 
          ...
          headerAction={<Toggle name="showDateDetails" checked={data.showDateDetails} onChange={handleChange} />}
        >
          <div className="form-group">
            <label className="form-label">Date</label>
            <input type="date" className="form-input" name="date" value={data.date} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label className="form-label">Time</label>
            <input type="time" className="form-input" name="time" value={data.time} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label className="form-label">Order Number</label>
            <input className="form-input" name="orderNumber" value={data.orderNumber} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label className="form-label">Server/Cashier Name</label>
            <input className="form-input" name="cashierName" value={data.cashierName} onChange={handleChange} />
          </div>
        </Accordion>
        ...
        <Accordion title="Items" icon={<ShoppingBag size={16} />}>
          <div className="form-group">
            ...
            <CustomSelect 
              options={[
                { label: 'Standard (1 Column)', value: 'standard' },
                { label: 'Comparative (2 Columns)', value: 'comparative' }
              ]} 
              value={data.itemLayout} 
              onChange={(val) => handleSelectChange('itemLayout', val)} 
            />
          </div>
          ...
          <button className="btn btn-secondary" style={{ width: '100%', marginTop: '0.5rem' }} onClick={addItem}>
        ...
        <Accordion 
          ...
          headerAction={<Toggle name="showTotals" checked={data.showTotals} onChange={handleChange} />}
        >
          <div className="form-group">
            <label className="form-label">Tax Rate (%)</label>
            <input type="number" className="form-input" name="taxRate" value={data.taxRate} onChange={handleChange} step="0.01" />
          </div>
          <div className="form-group">
            <label className="form-label">Discount Amount</label>
            <input type="number" className="form-input" name="discount" value={data.discount} onChange={handleChange} step="0.01" />
          </div>
          <div className="form-group">
            <label className="form-label">Currency Symbol</label>
            <input className="form-input" name="currencySymbol" value={data.currencySymbol} onChange={handleChange} />
          </div>
        </Accordion>
        ...
        <Accordion 
          ...
          headerAction={<Toggle name="showFooter" checked={data.showFooter} onChange={handleChange} />}
        >
          <div className="form-group">
            <label className="form-label">Footer Message</label>
            <textarea className="form-textarea" name="footerMessage" value={data.footerMessage} onChange={handleChange} />
          </div>
          <LabeledToggle label="Show Barcode" name="showBarcode" checked={data.showBarcode} onChange={handleChange} />
        </Accordion>
